...
router.post(
  "/:cid/products/:pid",
  cartsManagerMongo.addProductToCart.bind(cartsManagerMongo)
);
...
router.delete(
  "/:cid/products/:pid",
  cartsManagerMongo.deleteProductToCart.bind(cartsManagerMongo)
);
...
router.put(
  "/:cid/products/:pid",
  cartsManagerMongo.updateQuantityProduct.bind(cartsManagerMongo)
);

router.delete(
  "/:cid",
  cartsManagerMongo.deleteAllProductsToCart.bind(cartsManagerMongo)
);
