...
async updateProduct(req,res){
    try {
      ...
      const productsContent = await fs.promises.readFile(this.productsFilePath, 'utf-8')
      ...
      await fs.promises.writeFile(this.productsFilePath, JSON.stringify(productos, null, 2))
